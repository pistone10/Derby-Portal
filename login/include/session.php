...
class Session
{
    ...
    */
   function register($subuser, $subpass, $subconf_pass, $subemail, $subconf_email, $subname, $subderby, $subphone){
      ...
      if($database->addNewUser($subuser, $subpass, $subemail, $subname, $subderby, $subphone, $token, $usersalt)){
