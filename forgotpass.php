...
<div class="container">
	<section id="content">
		<form action="login/process.php" method="POST">
			...
			<p>Please fill out the form below. You'll need your username and the
e-mail address you used to register<br />(unless you have since changed it). <br /><?php echo $form->error("user"); ?><br /></p>
			<div>
				<input type="text" tabindex="1" placeholder="Username" name="user" value="<?php echo $form->value("user"); ?>">
			</div>
			<div>
				<input type="text" tabindex="2" placeholder="Email Address" name="email" value="<?php echo $form->value("email"); ?>">
			</div>
			<div>
