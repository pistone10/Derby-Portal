...
class AdminProcess
{
   ...
   function AdminProcess(){
      ...
      /* Admin submitted verify user form */
      if(isset($_POST['subverifyuser'])){
         $this->procVerifyUser();
      }
   ...
   /**
    * procVerifyUser - If the submitted username is correct,
    * the user if verified and user level is updated to admins selection.
    */
   function procVerifyUser(){
