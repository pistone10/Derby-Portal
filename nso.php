...
<body>
	...
	<section id="main" class="column">
		<article class="module width_full">
			<header><h3>Jam Timer</h3></header>
				<div class="module_content">
					<p>Properly Signals jam start, and end of jam. Properly maintain jam, timeout, and period timing. Effectively signals time outs. Effectively signals end of jam.</p>
				</div>
		</article><!-- end of styles article -->
		
		<article class="module width_full">
			<header><h3>Penalty Tracker</h3></header>
				<div class="module_content">
					<p>Accurately and effectively receives and documents penalties from other officials.</p>
				</div>
		</article><!-- end of styles article -->
